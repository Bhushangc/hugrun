...
@section('content')
    <section id="articles">
        <div class="articles-categories">
            <div class="articles-title">
                ...
                @foreach ($allBlogs as $blog)
                    <p @if ($blog->id == $currentBlog->id)id="current-page"@endif><a href="{{ route('article.parents.is', ['id' => $blog->id]) }}">
                            @if ($blog->islandicBlog)
                                {{$blog->islandicBlog->title}}
                            @else
                                {{ $blog->title }}
                            @endif 
                        </a>
        ...
        <div class="articles-categories-mobile">
            <div class="articles-title">
                <div class="top-nav">
                    <h1>Upplýsingar fyrir foreldra</h1> 
                </div>
                <div class="bottom">
                    @foreach ($allBlogs as $blog)
                        <p @if ($blog->id == $currentBlog->id)id="current-page"@endif><a href="{{ route('article.parents.is', ['id' => $blog->id]) }}">
        ...
        <div class="articles-contents">
            <div class="articles-contents-heading">
                ...
                <h6>Upplýsingar fyrir foreldra > <span>{{ $currentBlog->title }}</span></h6>
