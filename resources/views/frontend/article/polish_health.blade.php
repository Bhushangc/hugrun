    ...
    <section id="articles">
        <div class="articles-categories">
            <div class="articles-title">
                <h1>Upplýsingar um geðheilbrigði</h1> <hr>
                    @foreach ($allBlogs as $blog)
                        <p @if ($blog->id == $currentBlog->id)id="current-page"@endif><a href="{{ route('article.health.po', ['id' => $blog->id]) }}">
                                @if ($blog->polishBlog)
        ...
        <div class="articles-categories-mobile">
            <div class="articles-title">
                <div class="top-nav">
                    <h1>Upplýsingar um geðheilbrigði</h1> 
                </div> 
                <div class="bottom">
                    @foreach ($allBlogs as $blog)
                        <p @if ($blog->id == $currentBlog->id)id="current-page"@endif><a href="{{ route('article.health.po', ['id' => $blog->id]) }}">
        ...
        <div class="articles-contents">
            <div class="articles-contents-heading">
                ...
                <h6>Upplýsingar um geðheilbrigði > <span>{{ $currentBlog->title }}</span></h6>
