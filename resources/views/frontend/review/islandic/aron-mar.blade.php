...
@section('content')
    ...
    <section id="next_campaign">
        <div class="next_campaign_heading">
            <h2><a href="{{ route('review', ['name' => 'vala-kristin', 'lan' => 'is']) }}"><i class="fa-solid fa-arrow-left"></i></a>&nbsp;&nbsp;Fyrri grein </h2>
        </div>
        <div class="next_campaign_heading">
            <h2>Næsta grein &nbsp;<a href="{{ route('review', ['name' => 'tryggvi', 'lan' => 'is']) }}"><i class="fa-solid fa-arrow-right"></i></a></h2>
        </div>
    </section>
