...
@section('content')
    ...
    <section id="campaign-content">
        <div class="campaign-div-content">
            <p>"When you get sick mentally, it affects you physically. Not everyone realizes that. When you can't catch a moment of sleep but have to wake up for work, or in my case to attend practice, it takes a toll on you physically," says former national team player Hrefna Huld Jóhannesdóttir, who in late 2008 began to experience symptoms of schizophrenia.</p>

            <p>Hrefna Huld Jóhannsdóttir has a successful football career behind her with the national team. She was a professional in Norway and is the sixth top scorer in Iceland's top division ever. Hrefna is characterized by relaxation and laughter. She is in a good place today and ready to share her experience with schizophrenia.</p>
    ...
    <section id="campaign-content-II">
        <h2>Put the shoes on the shelf</h2>
        <p>"I was starting to be able to run less, I came out worse on endurance tests and simpler things like stretching had become difficult for me. This is a side effect of mental illness," says Hrefna, who subsequently made the decision to move down to the first ward and listen to her body. "I needed to relax and take care of myself. Of course it was sad and painful. I would have liked to end my career differently, but I did what I had to and there are no regrets."</p>

        <blockquote>
        <p>"The way the disease manifests itself is very personal, and therefore there is no one specific manifestation of schizophrenia."</p>
        </blockquote>
        <p>In Hrefna's case, schizophrenia manifests itself in voices she began to hear. "I didn't sleep for days and knew that all was not well. I felt very bad and I was ashamed. Fortunately, I was very quick to realize that I needed to do something about it. The way the disease manifests itself is very personal, and therefore there is no one specific manifestation of schizophrenia. My brother took me to a psychiatric hospital and I am extremely grateful to him today. He is a special guy who was there for me and comforted me, said there will be better times and everything will be fine. After that, we had more visits to the psychiatric ward, which led to a diagnosis of schizophrenia in 2009."</p>
    ...
    <section id="campaign-content">
        <div class="campaign-div-content">
            <h2>Had no energy during the day</h2>
            <p>Over the years, Hrefna has visited a psychiatric ward many times on her own initiative. Usually because of the voices she hears and the insomnia that comes with it. "I didn't have the energy for a normal day and struggled to take care of myself and get out of bed. Maybe it's something that not everyone understands, what it's like to not have the energy to face a new day."</p>
            <p>When asked, she says she feels stigmatized towards her illness and that society needs to accept that we are not all the same. "Just because I have a mental illness doesn't mean everyone else falls under the category of being normal." At least that's how I see it, we need to accept people as they are. There is a huge stigma in society, people avoid you and are afraid of you. You're not asked for your opinion and everyone doesn't care about your opinion, it doesn't count."</p>
            </div>
    ...
    <section id="campaign-content-II">
            ...
            <p>Hugrún would also like to point out the resources that are available to those who believe they are experiencing symptoms of schizophrenia here .</p>
    </section>
    <section id="next_campaign">
        <div class="next_campaign_heading">
            <h2><a href="{{ route('review', ['name' => 'tryggvi', 'lan' => 'en']) }}"><i class="fa-solid fa-arrow-left"></i></a>&nbsp;&nbsp;Previous article </h2>
        </div>
        <div class="next_campaign_heading">
            <h2>Next article &nbsp;<a href="{{ route('review', ['name' => 'SONJABJÖRG', 'lan' => 'en']) }}"><i class="fa-solid fa-arrow-right"></i></a></h2>
        </div>
    </section>
